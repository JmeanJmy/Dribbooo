...
public class ShotListFragment$$ViewBinder<T extends ShotListFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ShotListFragment> implements Unbinder {
    private T target;
