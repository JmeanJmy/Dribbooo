...
public class ShotFragment$$ViewBinder<T extends ShotFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ShotFragment> implements Unbinder {
    private T target;
